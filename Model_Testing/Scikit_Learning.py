...
# MULTICLASS CHANGE: RandomForestClassifier natively supports multiclass;
# predict_proba returns the full [n_rows, n_classes] matrix aligned to
# model.classes_.
...
# BINARY-CLASSIFICATION ROLLBACK:
# plt.plot(pred_prob, true_prob, marker="o", color="blue", label="Random Forest")
...
for class_index, class_label in enumerate(class_labels):
    ...
    plt.plot(pred_prob, true_prob, marker="o", label=f"Logistic Regression class {class_label}")
